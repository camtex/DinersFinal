  ...
  <footer className="bg-diners-twilight text-white py-24 border-t border-diners-lakefront/20 relative overflow-hidden">
    ...
    <div className="container mx-auto px-6 relative z-10">
      <div className="grid lg:grid-cols-12 gap-16 mb-20">
        <div className="lg:col-span-5">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="font-black tracking-tight text-2xl">Diners Club <span className="font-light text-diners-blue-sky">Perú</span></span>
          </div>
          <p className="text-diners-gray-1 font-light text-lg leading-relaxed max-w-md mb-10">
            Pertenecemos a una red global de excelencia. En Perú, somos líderes en brindar experiencias exclusivas y soluciones financieras de alto valor, impulsando el talento del futuro.
          </p>
        ...
        <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-12">
          <div>
            <h4 className="font-black text-xs uppercase tracking-[0.2em] mb-8 text-diners-blue-sky">Compañía</h4>
      ...
      <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] font-black uppercase tracking-widest text-diners-gray-4">
        <p>© 2024 Diners Club Perú. Todos los derechos reservados.</p>
